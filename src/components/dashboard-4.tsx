...
import { NewSimulationFormStep03b } from "@/components/new-simulation-form-step03b";
                ...
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    <Avatar className="h-8 w-8 rounded-lg">
                      <AvatarImage alt="monkeydluffy" src="/images/avatar.jpeg" />
                      <AvatarFallback className="rounded-lg">CN</AvatarFallback>
                    </Avatar>
                    <div className="grid flex-1 text-left text-sm leading-tight">
                      <span className="truncate font-semibold">Monkey D. Luffy</span>
                      <span className="truncate text-xs">monkeydluffy@pirateking.com</span>
                    </div>
